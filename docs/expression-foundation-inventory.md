...
| Octal escapes and interpolation                                             | Not implemented             | No expression-bearing string representation                                   | Add string segments and left-to-right interpolation evaluation.              |
