...
| [micro-runtime-followups.md](planning/micro-runtime-followups.md) | Correctness, lifecycle, security, and Cargo feature-matrix follow-ups for the slim VM runtime. |
