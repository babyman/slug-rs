...
| [agentic-development-refactoring.md](planning/agentic-development-refactoring.md) | Organizational refactoring plan for discoverable subsystem boundaries and focused validation. |
