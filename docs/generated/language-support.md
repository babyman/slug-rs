...
| Type annotation syntax, function-value inference/calls, nil-control-flow narrowing, mandatory resolution, and checked known operations | implemented | `tests/cli.rs` |
