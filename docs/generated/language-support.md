...
| Cooperative task handles with `spawn`, `await`, failure settlement, pending-sibling cancellation, explicit nurseries, and zero-limit admission | partial | `tests/cli.rs` |
