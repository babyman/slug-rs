...
| Nominal `resource Name` declarations, exported type paths, strongly typed source signatures, and whole-case match constraints | partial | `tests/cli.rs` and `language/nominal-types.md` |
