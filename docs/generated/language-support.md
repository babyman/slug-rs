...
| Cooperative task handles with `spawn`, `await`, failure settlement, pending-sibling cancellation, explicit nurseries, and queued direct-task limits | partial | `tests/cli.rs` |
