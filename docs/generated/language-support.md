...
| Cooperative task handles with `spawn`, `await`, failure settlement, pending-sibling cancellation, explicit nurseries, and direct-task admission limits | partial | `tests/cli.rs` |
